...
if mesh_comm.rank == model_rank:
	...
	wiresp_tags = list()
	wiresn_tags = list()
	mod.addPhysicalGroup(gdim, [strands_p[0]], k+1, name="wiresp")
	wiresp_tags = [k+1]
	k = k+1
	mod.addPhysicalGroup(gdim, [strands_n[0]], k+1, name="wiresn")
	wiresn_tags = [k+1]
...
with myFile0 as file:
	...
	file.write("wirepsID_"+str(1)+" = "+str(wiresp_tags)+";\n")
	file.write("wiresnID_"+str(i+1)+" = "+str(wiresn_tags)+";\n")
myFile0.close()
